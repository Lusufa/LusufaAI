...
import { Eraser, FileText, Notebook, House, Image, LogOut, Scissors, SquarePen, Users } from 'lucide-react';
...
const navItems = [
    ...
    {to: '/ai/blog-titles', label: 'Blog Titles', Icon: Notebook},
        ...
        <div className='px-6 mt-5 text-sm text-gray-600 font-medium'>
            {navItems.map(({to, label, Icon})=>(
                 <NavLink
                  ...
                  className={({ isActive }) =>
                    `flex items-center gap-3 px-3.5 py-2.5 rounded-md cursor-pointer transition
                    ${isActive 
